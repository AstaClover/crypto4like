...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='crypto4like.conf'
CONFIGFOLDER='/root/.crypto4like'
COIN_DAEMON='crypto4liked'
COIN_CLI='crypto4like-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/AstaClover/crypto4like/releases/download/1/c4l.tar.gz'
...
#Nodes
addnode=69.90.132.156:53388
addnode=76.74.170.27:53388
addnode=113.212.123.224:53388
addnode=207.148.116.116:53388
EOF
}
